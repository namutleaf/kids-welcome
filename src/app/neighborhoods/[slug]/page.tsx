  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <div className="mt-2 flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="flex items-center gap-2 text-2xl font-extrabold text-stone-800 dark:text-stone-100">
            <span aria-hidden>{neighborhood.icon}</span>
            {neighborhood.name}
          </h1>
        ...
        <Link
          ...
          className="rounded-full border border-teal-400 px-4 py-2 text-sm font-semibold text-teal-700 hover:bg-teal-50 dark:text-teal-300 dark:hover:bg-teal-950/40"
        >
